...
In this directory,
you will find all the STAT 450 labs.

Each subdirectory contains all the files necessary to generate the lab.
...
- The free online [book](https://r4ds.had.co.nz/) *R for Data Science*,
...
is usually very easy to follow
- [GitKraken](https://www.gitkraken.com/download)
is a nice git GUI that works for mac, Windows, and Linux
