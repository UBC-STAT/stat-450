...
Please contact the instructors at [stat450\@stat.ubc.ca](mailto:stat450@stat.ubc.ca){.email} if you have personal or administrative questions that do not pertain to the course material (e.g., Centre for Accessibility registration, medical issues, mental health, special requests, etc).
...
| Labs                                       | 10%    |
| Group Project (see Table 2 for breakdown)  | 80%    |
...
: Table 2: Group Project Breakdown
...
A penalty of 0.5% per hour, up to a maximum of 48 hours (24%) will be given for late submissions. After 48 hours, no submissions will be accepted, and a grade of 0 will be given.
...
We, the instructors, will do our best to stay well, but if we are ill, we will not come to class. If that happens, here’s what you can expect: - Another instructor will substitute. - Class may take place over Zoom (in this case, Zoom link will be posted on Canvas).
